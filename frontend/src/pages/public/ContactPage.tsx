        ...
        <nav className="border-b border-zinc-200/90 bg-white/95 backdrop-blur-md sticky top-0 shadow-xs">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
            <Link to="/" className="flex items-center gap-3.5 group">
              <img
                src="/slid-logo.png"
                alt="SLID Crest"
                className="w-14 h-14 sm:w-16 sm:h-16 object-contain filter drop-shadow-sm group-hover:scale-105 transition-transform duration-300"
              />
          ...
          {mobileMenuOpen && (
            <div className="lg:hidden border-t border-zinc-200 bg-white px-4 py-4 space-y-2 shadow-lg">
              ...
              <Link to="/services" className="block text-xs font-semibold text-zinc-800 p-2.5 rounded-lg hover:bg-zinc-50">
                📑 Statutory Services
              </Link>
              ...
              <Link to="/contact" className="block text-xs font-semibold text-[#1E8E5A] p-2.5 rounded-lg bg-emerald-50">
