      ...
      <header className="border-b border-purple-200 bg-white/95 backdrop-blur-md sticky top-0 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/staff/login"
              className="bg-[#4C1D95] hover:bg-[#3B0764] text-white text-xs font-semibold px-4 py-2 rounded-lg transition shadow-xs flex items-center gap-1.5"
            >
              <span>🏛️</span>
            ...
            <Link
              to="/staff/signup"
              className="hidden sm:inline-flex border border-[#4C1D95] text-[#4C1D95] hover:bg-purple-50 text-xs font-semibold px-3.5 py-2 rounded-lg transition"
            >
              Staff Provisioning
            </Link>
          </div>
